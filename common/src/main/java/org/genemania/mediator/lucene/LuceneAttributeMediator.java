...
public class LuceneAttributeMediator extends LuceneMediator implements AttributeMediator {
    ...
    public List<AttributeGroup> findAttributeGroupsByOrganism(long organismId) {
        var result = new ArrayList<AttributeGroup>();
	...
	public AttributeGroup findAttributeGroup(long organismId, long attributeGroupId) {
        var attributeGroup = new AttributeGroup[1];
    ...
    protected AttributeGroup createAttributeGroup(Document document) {
        ...
        var fieldVal = document.get(LuceneMediator.ATTRIBUTEGROUP_DEFAULT_SELECTED);
