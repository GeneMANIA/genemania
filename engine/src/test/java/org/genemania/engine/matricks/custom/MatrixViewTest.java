...
public class MatrixViewTest {
    ...
    public void viewTest() throws Exception {
        ...
        MatrixView view = new MatrixView(matrix, rowIndices, colIndices);
        assertEquals(2, view.numRows());
        assertEquals(2, view.numCols());
        
        // data must match
        assertEquals(matrix.get(8, 1), view.get(0, 0), 0d);
        assertEquals(matrix.get(8, 3), view.get(0, 1), 0d);
        assertEquals(matrix.get(9, 1), view.get(1, 0), 0d);
        assertEquals(matrix.get(9, 3), view.get(1, 1), 0d);
